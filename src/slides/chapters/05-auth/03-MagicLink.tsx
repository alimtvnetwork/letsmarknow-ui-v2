      ...
      <div className="h-full flex flex-col">
        <div className="mb-6">
          <h2 className="text-6xl font-bold leading-tight">
            Magic link — passwordless, in 4 hops.
          </h2>
          ...
          {[
            {
              ...
              n: "01",
              t: "Request",
              s: "POST /v1/auth/magic-link/send → always 202, no enumeration.",
            ...
            },
            {
              ...
              n: "02",
              t: "Email",
              s: "CTA button + requesting IP + UA + expiry. 'Didn't request? Ignore.'",
            ...
            },
            {
              ...
              n: "03",
              t: "Click",
              s: "GET /v1/auth/magic/callback?t=… consumes token, sets consumed_at.",
            ...
            },
            {
              ...
              n: "04",
              t: "Sign in",
              s: "JWT + refresh cookie issued. 302 → ?next= (origin-validated) or /dashboard.",
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{ background: `${step.color.replace(")", " / 0.15)")}` }}
                >
        ...
        <div className="mt-6 grid grid-cols-3 gap-4">
          <div className="rounded-xl border border-[hsl(var(--slide-border))] bg-[hsl(var(--slide-surface))] px-5 py-3 flex items-center gap-3">
            ...
            <div className="text-sm">
              <span className="font-bold">15 min</span> token TTL · denylisted 24h after consume
            </div>
          </div>
          <div className="rounded-xl border border-[hsl(var(--slide-border))] bg-[hsl(var(--slide-surface))] px-5 py-3 flex items-center gap-3">
            <ShieldAlert className="w-5 h-5 text-[hsl(var(--slide-warning))]" />
            <div className="text-sm">
              <span className="font-mono">1/60s</span>, <span className="font-mono">5/24h</span> per email · <span className="font-mono">10/h</span> per IP
            </div>
          </div>
          <div className="rounded-xl border border-[hsl(var(--slide-border))] bg-[hsl(var(--slide-surface))] px-5 py-3 flex items-center gap-3">
            <CheckCircle2 className="w-5 h-5 text-[hsl(var(--slide-success))]" />
            <div className="text-sm">
              No-account flow auto-creates Account + Personal Org
            </div>
          </div>
        </div>
      </div>

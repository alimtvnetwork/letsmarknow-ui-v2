...
const methods = [
  {
    ...
    sub: "Primary path. Argon2id hash, HIBP-checked, no composition rules.",
    color: "hsl(var(--slide-accent))",
  },
  {
    icon: Wand2,
    title: "Magic link",
    sub: "Passwordless. 32-byte token, sha256 at rest, 15-min TTL, single-use.",
    color: "hsl(var(--slide-accent-2))",
  },
  {
    icon: Chrome,
    title: "OAuth — Google",
    sub: "PKCE on extension via chrome.identity. Code flow on web.",
    color: "hsl(var(--slide-success))",
  },
  {
    icon: Apple,
    title: "OAuth — Apple",
    sub: "Sign in with Apple. Hidden-email aliases supported.",
    color: "hsl(var(--slide-fg))",
  },
  {
    icon: Github,
    title: "OAuth — GitHub",
    sub: "For the developer persona. Scope limited to email + profile.",
    color: "hsl(var(--slide-warning))",
  },
  {
    icon: Building2,
    title: "SAML SSO",
    sub: "Team Enterprise only. JIT provisioning, role mapping from IdP groups.",
    color: "hsl(var(--slide-accent))",
  },
];
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{ background: `${m.color.replace(")", " / 0.15)")}` }}
                >

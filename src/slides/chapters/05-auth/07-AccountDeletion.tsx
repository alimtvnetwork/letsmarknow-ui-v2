        ...
        <div className="flex-1 grid grid-cols-2 gap-7">
          ...
          <div className="rounded-2xl border border-[hsl(var(--slide-border))] bg-[hsl(var(--slide-surface))] p-6 flex flex-col">
            ...
            <div className="space-y-3 flex-1">
              {[
                ...
                { icon: Undo2, t: "T+7d / T+29d — reminder + restore", s: "Sign in to cancel. One click restores Personal Org. Foreign-Org memberships not auto-restored.", color: "hsl(var(--slide-success))" },
                { icon: Trash2, t: "T+30d — hard delete", s: "Account row destroyed. created_by → null ('Deleted user'). Audit-log actor_id retained for compliance.", color: "hsl(var(--slide-warning))" },
              ].map((step) => {
          ...
          <div className="rounded-2xl border border-[hsl(var(--slide-border))] bg-[hsl(var(--slide-surface))] p-6 flex flex-col">
            ...
            <div className="text-base text-[hsl(var(--slide-muted))] mb-5">
              <span className="font-mono text-sm text-[hsl(var(--slide-fg))]">/me/security/export</span> — async ZIP, signed URL (24h TTL),
              also emailed when ready. Available regardless of deletion status.
            </div>

      ...
      <div className="h-full flex flex-col pt-12">
        ...
        <div className="grid grid-cols-2 gap-8 flex-1">
          <div className="space-y-4">
            <div className="rounded-xl border border-[hsl(var(--slide-border))] bg-[hsl(var(--slide-surface))] p-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-semibold">T+0h · Soft prompt</span>
              </div>
            ...
            <div className="rounded-xl border border-[hsl(45_90%_60%_/_0.5)] bg-[hsl(var(--slide-surface))] p-5">
              <div className="flex items-center gap-3 mb-2">
                <Clock className="w-5 h-5 text-[hsl(45_90%_60%)]" />
                <span className="font-semibold">T+24h · Persistent</span>
              </div>
            ...
            <div className="rounded-xl border border-[hsl(0_70%_60%_/_0.5)] bg-[hsl(var(--slide-surface))] p-5">
              <div className="flex items-center gap-3 mb-2">
                <ShieldAlert className="w-5 h-5 text-[hsl(0_70%_60%)]" />
                <span className="font-semibold">T+72h · Required</span>
              </div>
          ...
          <div className="rounded-2xl border-2 border-[hsl(0_70%_60%_/_0.5)] bg-[hsl(var(--slide-surface))] p-8 flex flex-col">
            ...
            <button className="mt-auto w-full py-3 rounded-lg bg-[hsl(var(--slide-accent))] text-black font-semibold">
              Reload to update
            </button>
          </div>
        </div>

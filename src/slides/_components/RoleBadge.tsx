...
const roleStyles: Record<Role, string> = {
  ...
  editor: "bg-[hsl(var(--slide-success)/0.2)] text-[hsl(var(--slide-success))] border-[hsl(var(--slide-success)/0.4)]",
  viewer: "bg-[hsl(var(--slide-muted)/0.2)] text-[hsl(var(--slide-muted))] border-[hsl(var(--slide-muted)/0.4)]",
  billing: "bg-[hsl(var(--slide-warning)/0.2)] text-[hsl(var(--slide-warning))] border-[hsl(var(--slide-warning)/0.4)]",
  guest: "bg-[hsl(var(--slide-warning)/0.15)] text-[hsl(var(--slide-warning))] border-[hsl(var(--slide-warning)/0.3)]",
  system: "bg-[hsl(var(--slide-fg)/0.1)] text-[hsl(var(--slide-fg))] border-[hsl(var(--slide-fg)/0.3)]",
};

...
1. **Lock the folder-overview rule in CI.** Add a 12th sub-check to `spec-drift-linter` enforcing `every folder under 02-spec/21-app/ has a 00-overview.md`. Makes F-FOLDER-OVERVIEW non-regressable.
...
4. **Document the `00-overview.md` template formally.** A new file `02-spec/21-app/templates/folder-overview.md` would let future folder authors copy the structure verbatim, removing any improvisation.

...
> Single home for all audit, gap-analysis, scoring, sequencing, and retrospective documents that score or critique the spec corpus. Moved here on 2026-04-19 to keep `02-spec/21-app/` root clean and make audit history discoverable as a unit.

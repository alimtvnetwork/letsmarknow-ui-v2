...
> **W-6 closure (2026-04-19):** SKU period suffix is locked as `_yearly` (never `_annual`) across all 16 files in this folder. Verified by `grep -r "_annual" 02-spec/21-app/10-licensing-billing/` returning only this withdrawal note.

...
- **Conformance check:** `grep -rE '/v1/[^"]*\{[a-z_]+\}' 02-spec/21-app/` MUST return zero results. CI will fail if any `{...}` path-param appears in a `/v1/...` URL.

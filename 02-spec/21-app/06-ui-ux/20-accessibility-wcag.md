...
- Findings logged in `02-spec/21-app/audit-{date}-a11y.md`.
...
Registry maintained at `02-spec/21-app/06-ui-ux/08-keyboard-input.md`. New shortcuts MUST be added there with conflict check; CI fails on duplicates.

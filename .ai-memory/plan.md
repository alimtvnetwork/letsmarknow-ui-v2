...
## Goal
Build a **web-based, frontend-focused presentation** (slides app inside this React/Vite project) that explains the LMN extension + web app from the **user's point of view** — every screen, every click, every flow — sourced from the `02-spec/` folder.
